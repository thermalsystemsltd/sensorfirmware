...
///////////////////////////////////////////////////////////////NEW LBT CODE ///////////////////////////////////////////
    ...
    pinMode(12, OUTPUT); // Ensure GPIO10 is set as an output
    delay(80);
    
    digitalWrite(12, HIGH); // Set GPIO10 high to signal "done" to the TPL5110 timer  
    Serial.println("Hold GPIO HIGH"); 
    delay(2000); // Hold signal for a short period
            ...
            if (connectToWiFi(decodedSSID, decodedPassword)) {
                ...
                if (isNewFirmwareAvailable()) {
                    if (performOTAUpdate(sensor_firmware_version_url, firmwareBinURL)) {
                        ...
                        Serial.println("Signaling TPL5110 to power cycle...");
                        pinMode(10, OUTPUT);
